...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	<head>
		...
		var loader = new YAHOO.util.YUILoader({
		    ...
		    require: [ "reset-fonts-grids", "menu", "followme" ],
					...
					<div class="yui-ge">
						<div class="yui-u first">
							<div id="content-container">
								<div id="content-header">Papyrus CMS Suite</div>
								<div id="content"><!-- CONTENT BEGIN -->
									
									<div class="content-section papyrus-content-type-section">
										<div class="content-heading">Text Section</div>
									...
									<div class="content-section papyrus-content-type-section">
										<div class="content-heading">Downloads Section</div>
												...
												<div class="info-box-row-detail">
													<table>
														<tr>
															...
															<td><span class="info-box-field">Posted By:</span> <span class="info-box-field-data">Caige Nash</span></td>
														</tr>
													</table>
												</div>
									...
									<div class="content-section papyrus-content-type-section">
										<div class="content-heading">Link Section</div>
										<div class="content-body papyrus-editable papyrus-content-type-links"><ul><li><a href="#">Waterford</a></li><li><a href="#">KnowledgeBox</a></li><li><a href="#">ELLIS</a></li></ul></div>
									</div>
									
									<div class="content-section papyrus-content-type-section">
										<div class="content-heading">Picture Section</div>
										<div class="content-body papyrus-editable papyrus-content-type-photos"><ul><li><img src="http://bp3.blogger.com/_Wzqjp0V8ctg/Rg0p3f0zbVI/AAAAAAAAAAU/dgrAMwFoNpw/s320/DogObedienceTraining.jpg" /></li></ul></div>
									</div>
