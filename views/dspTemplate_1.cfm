...
<head>
	...
	<link rel="stylesheet" media="all" type="text/css" href="css/general_ie.css" />
					...
					<div id="contentInner">
						<div id="contentContent">
							...
							<div id="contentContentContainer">
								...
								<cfelseif viewCollection.exists("knowledgebase")>
									<cfoutput>#viewCollection.getView("knowledgebase")#</cfoutput>
								</cfif>		
							</div>
