...
<head>
	...
	<link rel="stylesheet" type="text/css" href="css/pdl/knowledgebase/kbase.css" />
	<!-- end stylesheets -->
	...
	<!-- Knowledgebase -->
	<script type="text/javascript" src="scripts/pdl/knowledgebase/kbsearch.js"></script> 
	<script type="text/javascript" src="scripts/pdl/knowledgebase/loadKnowledgebase.js"></script> 
	<!-- end Knowledgebase -->
...
<body>
	<div id="container">
					...
					<div id="contentInner">
						<div id="contentContent">
							...
							<div id="contentContentContainer">
								<div>
									<cfif viewCollection.exists("knowledgebaseSearchForm")>
										<cfoutput>#viewCollection.getView("knowledgebaseSearchForm")#</cfoutput>
									</cfif>
								</div>
								<div>
									<cfif viewCollection.exists("knowledgebaseResults")>
										<cfoutput>#viewCollection.getView("knowledgebaseResults")#</cfoutput>
									</cfif>
								</div>
								<div>
									<cfif viewCollection.exists("knowledgebaseArticle")>
										<cfoutput>#viewCollection.getView("knowledgebaseArticle")#</cfoutput>
									</cfif>
								</div>
							</div>
		...
		<div id="sidebarRightContainer">
			<cfif viewCollection.exists("sidebar_kbquicksearch")>
				<cfoutput>#viewCollection.getView("sidebar_kbquicksearch")#</cfoutput>
			</cfif>
			<cfif viewCollection.exists("sidebar_kbarticlesummary")>
				<cfoutput>#viewCollection.getView("sidebar_kbarticlesummary")#</cfoutput>
			</cfif>
		</div>
		</div>
