...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	<head>
		...
		var loader = new YAHOO.util.YUILoader({
		    ...
		    require: [ "reset-fonts-grids", "menu", "logger", "yuitest", "followme", "papyrus", "papyruseditor", "papyruspageeditor", "papyrussectioneditor", "ejs" ],
					...
					<div class="yui-ge">
						<div class="yui-u first">
							<div id="content-container">
								<div id="content-header">Papyrus CMS Suite <a href="#" id="papyrus-edit-page" onclick="YAHOO.widget.papyrus.Editor.edit( '1', 'page' );">Edit Page</a></div>
								<div id="content"><!-- CONTENT BEGIN -->
									
									<div class="content-section papyrus-content-type-section">
										<div class="yui-gc">
											<div class="yui-u first content-heading">Text Section</div>
											<div class="yui-u papyrus-edit-section-link"><a href="#" onclick="YAHOO.widget.papyrus.Editor.edit( '1', 'section' );">Edit Section</a></div>
										</div>
									...
									<div class="content-section papyrus-content-type-section">
										...
										<div class="content-body papyrus-editable papyrus-content-type-image"><ul><li><img src="http://bp3.blogger.com/_Wzqjp0V8ctg/Rg0p3f0zbVI/AAAAAAAAAAU/dgrAMwFoNpw/s320/DogObedienceTraining.jpg" /></li></ul></div>
									</div>
