...
tinyMCE.importThemeLanguagePack('cmshtmlcontent');

var TinyMCE_CMSHTMLContent = {
	// List of button ids in tile map
	_buttonMap : 'bold,bullist,hr,italic,numlist,redo,strikethrough,underline,undo',
	...
	getEditorTemplate : function() {
		...
		html += '<img src="{$themeurl}/images/separator.gif" width="2" height="20" class="mceSeparatorLine" />';
		html += tinyMCE.getButtonHTML('hr', 'lang_hr_desc', '{$themeurl}/images/hr.gif', 'inserthorizontalrule');
		html += '<img src="{$themeurl}/images/separator.gif" width="2" height="20" class="mceSeparatorLine" />';
		html += tinyMCE.getButtonHTML('removeformat', 'lang_removeformat_desc', '{$themeurl}/images/removeformat.gif', 'removeformat');
...
tinyMCE.addTheme("cmshtmlcontent", TinyMCE_CMSHTMLContent);
tinyMCE.addButtonMap(TinyMCE_CMSHTMLContent._buttonMap);
