...
YAHOO.widget.papyrus.SectionsEditorView = new function() { 
	...
	this.renderEdit = function() {
		...
		E = p.Editor;
		panel = E.getPanel();
		panel.setHeader( 'Papyrus - Editing Sections' );
		...
		Dom.get( "papyrus-editor-sections-view-edit-container" ).innerHTML = new EJS( { url : 'lib/pui/papyrus/editor/sections/views/edit.ejs'} ).render( p.SectionsEditorModel.getSections() );
