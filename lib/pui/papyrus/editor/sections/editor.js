...
YAHOO.widget.papyrus.SectionsEditor = new function() { 
	...
	this.init = function() {
		...
		this.initEvent.subscribe( YAHOO.widget.papyrus.SectionsEditorViewHelper.init, YAHOO.widget.papyrus.SectionsEditorViewHelper, true );
		this.initEvent.fire();
		this.controller = p.SectionsEditorController;
