...
YAHOO.widget.papyrus.SectionEditorView = new function() { 
	...
	this.renderEdit = function() {
		...
		E = p.Editor;
		panel = E.getPanel();
		E.setEditorBreadcrumb( 'Section Editor' );
		panel.setBody( '<div class="yui-gc"><div class="yui-u first"><div id="papyrus-editor-section-view-edit-container"></div></div><div class="yui-u" id="papyrus-editor-section-view-sidebar-container"><div id="papyrus-editor-section-view-sidebar-options-container"></div><div id="papyrus-editor-section-view-sidebar-tags-container"></div></div>' );
		Dom.get( "papyrus-editor-section-view-edit-container" ).innerHTML = new EJS( { url : 'lib/pui/papyrus/editor/section/views/edit.ejs'} ).render( p.SectionEditorModel.getSection() );
