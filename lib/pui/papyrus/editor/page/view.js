...
YAHOO.widget.papyrus.PageEditorView = new function() { 
	...
	this.renderEdit = function() {
		...
		panel.setBody( '<div class="yui-gc"><div class="yui-u first"><div id="papyrus-editor-page-view-edit-container"></div></div><div class="yui-u" id="papyrus-editor-page-view-sidebar-container"><div id="papyrus-editor-page-view-sidebar-options-container"></div><div id="papyrus-editor-page-view-sidebar-tags-container"></div></div></div>' );
