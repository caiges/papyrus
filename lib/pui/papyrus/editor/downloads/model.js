...
YAHOO.widget.papyrus.DownloadsEditorModel = new function() { 
	...
	this.findDownloadsBySectionId = function( section_id ) {
		...
		Util.Connect.asyncRequest( 'GET', "mocks/downloads/" + section_id + "_downloads.json", { success : onSuccess, failure : onFailure } );
