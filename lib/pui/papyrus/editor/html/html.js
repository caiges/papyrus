...
( function() { 
	...
	HTML.prototype = {
		...
		init : function( attributes ) {	
			...
			var properties = [ { el : "html[title]", getter : this.getTitle, setter : this.setTitle },
			 				   { el : "html[markup]", getter : this.getMarkup, setter : this.setMarkup },
							   { el : "html[is_active]", getter : this.getIsActive, setter : this.setIsActive }
							];
			...
			var validations = [ { value : this.getTitle, el : "html[title]", property : "Title", type : "string", length : 2 },
								{ value : this.getMarkup, el : "html[markup]", property : "Markup", type : "string", length : 5000 },
								{ value : this.getIsActive, el : "html[is_active]", property : "Is Active", type : "boolean" }
							  ];
