...
( function() { 
	...
	Download.prototype = {
		...
		init : function( attributes ) {	
			...
			var properties = [ { el : "download[title]", getter : this.getTitle, setter : this.setTitle },
			 				   { el : "download[uri]", getter : this.getUri, setter : this.setUri },
							   { el : "download[is_active]", getter : this.getIsActive, setter : this.setIsActive },
							   { el : "download[is_internal]", getter : this.getIsInternal, setter : this.setIsInternal }
							];
